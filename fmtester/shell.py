...
Usage:
  mnfm [--topology=FILE] [--loops=LOOPS] [--no-loop] [--retries=RETRY] [--interval=SEC] [--delay=SEC] [--no-links] [--ask-for-retry] [--controller=IP]...
  mnfm test [--topology=FILE] [--loops=LOOPS] [--no-loop] [--retries=RETRY] [--interval=SEC] [--delay=SEC] [--no-links] [--ask-for-retry] [--controller=IP]...
